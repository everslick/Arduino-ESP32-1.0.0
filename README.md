This is a fork of the original ESP32 Arduino core prior to it's 1.0.0 release. With Version 1.0.0 came PSRAM support and IDF 3.3 and this increased flash size requirements significantly. Nevertheless, some later bugfixes that went into upstream arduino-esp32 [have been backported](https://github.com/espressif/arduino-esp32/compare/master...everslick:master) to this fork.
